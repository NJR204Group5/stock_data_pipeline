CREATE TABLE IF NOT EXISTS stocks (
    ...
    stock_code VARCHAR(20) UNIQUE NOT NULL, -- 證券代號
    ...
    is_price_supported BOOLEAN DEFAULT TRUE,
...
CREATE INDEX IF NOT EXISTS idx_is_price_supported ON stocks(is_price_supported);
